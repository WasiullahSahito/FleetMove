...
class VehicleCategoryController extends Controller
{
    ...
    public function categoryFareList(Request $request): JsonResponse
    {
        ...
        $categories = $this->vehicleCategoryService->getBy(criteria: ['is_active'=>1], whereHasRelations: $whereHasRelations, relations: $relations,
            orderBy: ['name' => 'asc'], // <--- Sorting added here
