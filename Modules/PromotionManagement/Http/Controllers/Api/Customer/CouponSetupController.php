...
use Modules\UserManagement\Service\Interfaces\UserLevelServiceInterface;
    ...
    public function list(Request $request): JsonResponse
{
    ...
    $coupons = $this->couponService->getUserCouponList(
        data: $criteria,
        limit: $request->limit,
        offset: $request->offset
    );
    ...
    return response()->json(responseFormatter(
        constant: DEFAULT_200,
        content: CouponResource::collection($coupons),
        limit: $request->limit,
        offset: $request->offset
    ));
}
