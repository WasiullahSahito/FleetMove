...
class TripRequest extends Model
{
     ...
     protected function scheduledAt(): Attribute
    {
        return Attribute::make(
            get: function ($value) {
                ...
                try {
                    // Forces the output to always be YYYY-MM-DDTHH:mm:ss
    ...
    public function rejectedDriverRequests()
    {
        return $this->hasMany(RejectedDriverRequest::class, 'trip_request_id');
    }
