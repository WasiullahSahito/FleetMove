        ...
        <div class="aside-body" data-trigger="scrollbar">
            ...
            <ul class="main-nav nav">
                ...
                @if(\Illuminate\Support\Facades\Gate::any(['trip_view', 'trip_edit', 'trip_delete', 'trip_log', 'trip_export']))
                    ...
                    <!-- ================= ADDED BOOK NOW SECTION ================= -->
                    <li class="{{ Request::is('admin/book-now*') ? 'active sub-menu-opened' : '' }} text-capitalize">
                        <a href="#">
                            <i class="bi bi-calendar-plus"></i>
                            <span class="link-title">{{ translate('Manual_Booking') }}</span>
                        </a>
                        <ul class="nav flex-column sub-menu text-capitalize">
                            <li class="{{ Request::is('admin/book-now/create') ? 'active open' : '' }}">
                                <a href="{{ route('admin.book-now.create') }}">
                                    <i class="bi bi-dash-lg"></i>
                                    <span class="link-title">{{ translate('Book_Now') }}</span>
                                </a>
                            </li>
                            <!--<li class="{{ Request::is('admin/book-now/list*') || Request::is('admin/book-now/details*') ? 'active open' : '' }}">-->
                            <!--    <a href="{{ route('admin.book-now.index', ['all']) }}">-->
                            <!--        <i class="bi bi-dash-lg"></i>-->
                            <!--        <span class="link-title">{{ translate('Booking_List') }}</span>-->
                            <!--    </a>-->
                            <!--</li>-->
                        </ul>
                    </li>
