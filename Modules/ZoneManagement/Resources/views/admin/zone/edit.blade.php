                                    ...
                                    <div class="col-lg-7">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" name="name" id="zone_name"
                                                   value="{{ old('name', $zone->name) }}" placeholder="{{ translate('ex') }}: {{ translate('Dhanmondi') }}" required>
                                        </div>
                                            <!-- ADDED ZONE CODE FIELD -->
                                            <div class="mb-4">
                                                <label for="zone_code" class="form-label text-capitalize">{{ translate('zone_code') }} <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" name="zone_code" id="zone_code" value="{{ old('zone_code', $zone->zone_code) }}" placeholder="{{ translate('ex') }}: {{ translate('DOWNTOWN-1') }}" maxlength="50" required>
                                            </div>
                                            <!-- END ZONE CODE FIELD -->
