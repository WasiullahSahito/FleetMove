                            ...
                            <div class="card-body">
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="mb-4">
                                            <label for="zone_code"
                                                   class="form-label text-capitalize ">{{ translate('zone_code') }}
                                                <span class="text-danger">*</span></label>
                                            <input required type="text" class="form-control"
                                                   value="{{old('zone_code') }}" name="zone_code" id="zone_code"
                                                   placeholder="{{ translate('ex') }}: ZN-001">
                                        </div>
                                ...
                                <div class="table-responsive mt-3">
                                    <table class="table table-borderless align-middle">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-capitalize name">{{ translate('zone_code') }}</th>
                                        ...
                                        @forelse ($zones as $key => $zone)
                                            <tr id="hide-row-{{$zone->id}}" class="record-row">
                                                ...
                                                <td class="name">{{ $zone->zone_code ?? 'N/A' }}</td>
...
@push('script')
    ...
    <script>
        ...
        function extraFareSetupAlert(obj) {
            ...
            let zoneCode = $(obj).data('code') ? ` (${$(obj).data('code')})` : '';
            $("#zoneName").html(zoneName + zoneCode);
